...
function generateLevel(level) {
  ...
  // Find valid gate position — not inside any obstacle
...
export default function RCCarGame() {
  ...
  useEffect(() => {
    ...
    const loop = () => {
      ...
      // Obstacle collision — accurate AABB
      let hit = false
      ...
      if (
        ...
        // Move gate to new valid position
        setLevelData(prev => {
          let nx, ny, ok
          for (let a = 0; a < 100; a++) {
  ...
  return (
    <div className="bg-white border border-border rounded-2xl p-5 hover:shadow-md transition-shadow">
      ...
      >
        ...
        {/* Obstacles — nice gradient blocks */}
