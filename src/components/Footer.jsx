  ...
  return (
    <footer className="py-8 px-6 border-t border-border">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-xs text-muted">&copy; {new Date().getFullYear()} Dhakshin Mahesh</p>
        <div className="flex items-center gap-5">
          ...
          <a href="mailto:dhakshinmahesh1@gmail.com" className="text-muted hover:text-text transition-colors"><Mail size={16} /></a>
        </div>
      </div>
    </footer>
  )
